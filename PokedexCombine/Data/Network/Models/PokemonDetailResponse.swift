...
class JSONNullPokemonDetail: Codable, Hashable {

    public static func == (lhs: JSONNullPokemonDetail, rhs: JSONNullPokemonDetail) -> Bool {
        return true
    }
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if !container.decodeNil() {
            throw DecodingError.typeMismatch(JSONNullPokemonDetail.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for JSONNull"))
        }
    }
    ...
    static func encode(to container: inout UnkeyedEncodingContainer, array: [Any]) throws {
        for value in array {
            if let value = value as? Bool {
                ...
                try container.encode(value)
            } else if value is JSONNullPokemonDetail {
                try container.encodeNil()
